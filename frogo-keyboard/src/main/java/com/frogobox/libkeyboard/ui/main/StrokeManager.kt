...
class StrokeManager {
  ...
  interface ContentChangedListener {
    ...
    fun onContentChanged(result: String)
  }
  ...
  private val content: MutableList<RecognitionTask.RecognizedInk> = ArrayList()
  ...
  private fun commitResult() {
    recognitionTask!!.result()?.let {
      ...
      it.text?.let { it1 -> contentChangedListener?.onContentChanged(it1) }
    }
  }
